...
const DetailsPlace = () => {
    ...
    var detailBackground = {
        backgroundImage : "url("+travelInfo.item.image+")",
        ...
        <div style={detailBackground} className="detail">
            ...
            <div className="detail-container">
                <div className="detail-content">
                    <h1 className="detail-heading">{travelInfo.item.name}</h1>
                    <p>{travelInfo.item.detail}</p>
                </div>
                <div className="detail-form">
                    <form action="">
                        ...
                        <input className="detail-form__input" value={travelInfo.item.name} type="text" name="from-travel" id="from-travel"/>
